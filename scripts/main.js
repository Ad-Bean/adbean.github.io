...
let storyText = '今天气温 35 摄氏度，:inserta:出去遛弯。当走到:insertb:门前时，突然就:insertc:。人们都惊呆了，李雷全程目睹但并没有慌，因为:inserta:是一个 140 公斤的胖子，天气又辣么热。';
...
function result() {
    ...
    if (document.getElementById("american").checked) {
        let weight = Math.round(140 * 2.20462262185) + ' 磅';
        let temperature = Math.round(35 * 1.8 + 32) + ' 华氏度';
